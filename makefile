tetris5 : tetris5.o genMino.o Mino.o MinoI.o MinoS.o MinoL.o MinoO.o MinoZ.o
	g++ -o tetris5 tetris5.o genMino.o Mino.o MinoI.o MinoS.o MinoL.o MinoO.o MinoZ.o
